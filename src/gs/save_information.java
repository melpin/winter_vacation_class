...
public class save_information extends JDialog {
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			save_information dialog = new save_information();
	...
	public save_information() {
		...
		bgimage.setIcon(new ImageIcon("C:\\Users\\LEE\\Desktop\\\uC624\uD508\uC18C\uC2A4 (2)\\information_save.png"));
