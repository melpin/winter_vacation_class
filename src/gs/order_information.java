...
public class order_information extends JDialog {
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			order_information dialog = new order_information();
	...
	public order_information() {
		...
		bgimage.setIcon(new ImageIcon("C:\\Users\\LEE\\Desktop\\\uC624\uD508\uC18C\uC2A4 (2)\\information_order.png"));
