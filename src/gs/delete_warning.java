...
public class delete_warning extends JDialog {
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			delete_warning dialog = new delete_warning();
	...
	public delete_warning() {
		...
		bgimage.setIcon(new ImageIcon("C:\\Users\\LEE\\Desktop\\\uC624\uD508\uC18C\uC2A4 (2)\\warning_delete.png"));
