...
public class login_warning extends JDialog {
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			login_warning dialog = new login_warning();
	...
	public login_warning() {
		...
		bgimage.setIcon(new ImageIcon("C:\\Users\\LEE\\Desktop\\\uC624\uD508\uC18C\uC2A4 (2)\\dialogue_warning.png"));
