...
public class fail_warning extends JDialog {
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			fail_warning dialog = new fail_warning();
	...
	public fail_warning() {
		...
		bgimage.setIcon(new ImageIcon("C:\\Users\\LEE\\Desktop\\\uC624\uD508\uC18C\uC2A4 (2)\\warning_fail.png"));
