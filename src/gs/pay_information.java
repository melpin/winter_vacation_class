...
public class pay_information extends JDialog {
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		try {
			pay_information dialog = new pay_information();
	...
	public pay_information() {
		...
		bgimage.setIcon(new ImageIcon("C:\\Users\\LEE\\Desktop\\\uC624\uD508\uC18C\uC2A4 (2)\\information_pay.png"));
