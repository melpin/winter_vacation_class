...
public class testgraphic extends JPanel {
	...
	private static final Color GRAPH_COLOR = Color.black; // 선 색 설정
	private static final Color GRAPH_POINT_COLOR = new Color(150, 50, 50, 180); // 점 색 설정
	private static final Stroke GRAPH_STROKE = new BasicStroke(3f);
	private static final int GRAPH_POINT_WIDTH = 5; // 점크기
